...
<div class="mainFrame" style="position:relative; width: 480px; height: 1030px; background:white; display: inline-block; box-shadow: 0 0px 4px 4px lightgrey;">
    ...
    <div class="container" style="width:480px; height: 830px; position: absolute; background: white; top:100px; overflow: auto">
        ...
        <div style="width: 440px; height: 40px; margin: auto; text-align: center;">
            <div onclick="location.href='helper_ask'" style="width: 220px; height: 40px; display: inline-block; margin-right: 0; font-size: 20px; border-bottom: 4px solid black;">문의하기</div><div onclick="location.href='helper_myask'" style="width: 220px; height: 40px; display: inline-block; margin-left: 0; font-size: 20px; border-bottom: 2px solid #999; color:#999;">나의문의</div>
        </div>
        ...
        <form>
            ...
            <div style=" position: relative; width: 440px; height: 48px; margin: auto;">
                ...
                <button type="button" onclick="location.href='helper_myPage'" style=" position:absolute; top: 8px; right: 10px; width:100px; height: 48px; border-radius: 24px; background: #ccc; color: #999; font-size: 20px; border: none;">취소</button>
            </div>
        </form>
        <br><br>
