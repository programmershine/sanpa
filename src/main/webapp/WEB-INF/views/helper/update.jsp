        ...
        <c:if test="${helper.helper_status == 1}">
          ...
          <div class="mother_hidden_container" style="display: block">
            ...
            <div>
              ...
              <input name="mother_babyName" class="body_input" type="text" placeholder="태명" style="width: 180px; margin-top: 15px;" value="${mother.mother_babyName}"><br>
              ...
              <input name="mother_obHospital_tel" class="body_input" type="text" placeholder="산부인과 전화번호 ( - 없이)" style="width: 200px" maxlength="11" value="${mother.mother_obHospital_tel}"><br>
