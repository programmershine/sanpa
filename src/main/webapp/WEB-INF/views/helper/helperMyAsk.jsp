...
<div class="mainFrame" style="position:relative; width: 480px; height: 1030px; background:white; display: inline-block; box-shadow: 0 0px 4px 4px lightgrey;">
    ...
    <div class="container" style="width:480px; height: 830px; position: absolute; background: white; top:100px; overflow: auto">
        ...
        <div style="width: 440px; height: 40px; margin: auto; text-align: center;">
            <div onclick="location.href='helper_ask'" style="width: 220px; height: 40px; display: inline-block; margin-right: 0; font-size: 20px; border-bottom: 2px solid #999; color: #999;">문의하기</div><div onclick="location.href='helper_myask'" style="width: 220px; height: 40px; display: inline-block; margin-left: 0; font-size: 20px; border-bottom: 4px solid black; color:black;">나의문의</div>
        </div>
        ...
        <div style="width: 480px; height: 480px; overflow-y:auto;">
            <table style="width: 480px;">
                ...
                <tr onclick="location.href='helper_myaskdetail'" style="height: 48px;">
                    <td>2024-03-12</td>
                    <td>데이터2</td>
                    <td>데이터입니다 제목입니다</td>
                    <td>데이터3</td>
