...
<div class=”mainFrame”  style="position: relative; width: 480px; height: 1030px; border:1px solid black; display: inline-block;">
    ...
    <form action="login" method="post">
        <input type="text" placeholder="아이디"  name="helper_id" required
               style="background:#fffcfc; color: rgba(0, 0, 0, 0.5); padding: 10px;
					 margin: 10px; font-size: 20px; font-weight: bold; border-radius: 15px;
					 border: 1px solid rgba(0, 0, 0, 0.5)">
        <input type="password" placeholder="비밀번호"  name="helper_password" required
               style="background:#fffcfc; color: rgba(0, 0, 0, 0.5); padding: 10px;
					 margin: 10px; font-size: 20px; font-weight: bold; border-radius: 15px;
					 border: 1px solid rgba(0, 0, 0, 0.5)">
        <p style="text-align: left; margin-left: 100px;font-weight: bold; color: rgba(0, 0, 0, 0.4);
			 margin-top: 50px; margin-bottom: 50px;"><input type="checkbox">&nbsp;로그인 유지
        </p>
        <input type="submit" class="btn2"  value="로 그 인" style="width: 287px; height:44px; color: white;
					 background: #A9E5FF; text-align: center; font-size: 25px; padding: 25px auto;
					 border-radius: 15px; box-shadow: 2px 4px 4px 0px rgba(0,0,0,0.4); border: none;">
    </form>
    <br>
    <div style="display: flex; justify-content: center;">
            <button onclick="window.location.href='insertHelper'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">회원가입</button>
            <button onclick="window.location.href='findId'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">아이디 찾기</button>
            <button onclick="window.location.href='findPassword'" class="btn2" style="font-weight: bold; font-size: 16px; color: rgba(0, 0, 0, 0.3); margin: 40px 20px; background: white; border: none;">비밀번호 찾기</button>
    </div>
